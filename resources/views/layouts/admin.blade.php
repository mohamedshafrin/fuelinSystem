...
<head>
    ...
    <link href="{{ asset('admin_staff/assets/css/dashboard/dash_2.css') }}" rel="stylesheet" type="text/css" />
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu @if (!$segment) active @endif">
                        <a href="{{ url('fuelin') }}"
                            @if (!$segment) aria-expanded="true" @endif class="dropdown-toggle">
                            <div class="">
                    ...
                    @if (auth()->user()->hasRole('Admin'))
                        <li class="menu @if ($segment == 'fuel_station') active @endif">
                            <a href="{{ url('fuelin/fuel_station') }}"
                                @if ($segment == 'fuel_station') aria-expanded="true" @endif class="dropdown-toggle">
                                <div class="">
                    ...
                    <li class="menu @if ($segment == 'station_user') active @endif">
                        <a href="{{ url('fuelin/station_user') }}"
                            @if ($segment == 'station_user') aria-expanded="true" @endif class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu @if ($segment == 'customers') active @endif">
                        <a href="{{ url('fuelin/customers') }}"
                            @if ($segment == 'customers') aria-expanded="true" @endif class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                <span>Customers</span>
                            </div>
                    ...
                    @if (auth()->user()->hasRole('Manager'))
                        <li class="menu @if ($segment == 'request_fuel') active @endif">
                            <a href="{{ url('fuelin/request_fuel') }}"
                                @if ($segment == 'request_fuel') aria-expanded="true" @endif class="dropdown-toggle">
                                <div class="">
                    ...
                    @if (auth()->user()->hasRole('Admin'))
                        <li class="menu @if ($segment == 'fuel_station_request') active @endif">
                            <a href="{{ url('fuelin/fuel_station_request') }}"
                                @if ($segment == 'fuel_station_request') aria-expanded="true" @endif class="dropdown-toggle">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-git-pull-request"><circle cx="18" cy="18" r="3"></circle><circle cx="6" cy="6" r="3"></circle><path d="M13 6h3a2 2 0 0 1 2 2v7"></path><line x1="6" y1="9" x2="6" y2="21"></line></svg>
                                    <span>Fuel Station Request</span>
                                </div>
                            </a>
                        </li>

                        <li class="menu @if ($segment == 'schedules') active @endif">
                            <a href="{{ url('fuelin/schedules') }}"
                                @if ($segment == 'schedules') aria-expanded="true" @endif class="dropdown-toggle">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                    <span>Scheduled Request</span>
                                </div>
                            </a>
                        </li>

                        <li class="menu @if ($segment == 'rate_card') active @endif">
                            <a href="{{ url('fuelin/rate_card') }}"
                                @if ($segment == 'rate_card') aria-expanded="true" @endif class="dropdown-toggle">
                                <div class="">
                    ...
                    <li class="menu @if ($segment == 'request_fuel_cus') active @endif">
                        <a href="{{ url('fuelin/request_fuel_cus') }}"
                            @if ($segment == 'request_fuel_cus') aria-expanded="true" @endif class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-git-pull-request"><circle cx="18" cy="18" r="3"></circle><circle cx="6" cy="6" r="3"></circle><path d="M13 6h3a2 2 0 0 1 2 2v7"></path><line x1="6" y1="9" x2="6" y2="21"></line></svg>
                                <span>Customer Fuel Req.</span>
                            </div>
                        </a>
                    </li>

                    <li class="menu @if ($segment == 'report') active @endif">
                        <a href="{{ url('fuelin/report') }}"
                            @if ($segment == 'report') aria-expanded="true" @endif class="dropdown-toggle">
                            <div class="">
        ...
        <div id="content" class="main-content">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Ase CW1 © {{ date('Y') }} <a target="_blank" href="">Group</a>,
