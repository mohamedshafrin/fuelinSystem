...
<div class="col-lg-12 col-12  layout-spacing">
    <a href="{{ url('customer/addvehicles') }}" class="btn btn-theme float-right text-uppercase">
        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                    <h3 class="font-weight-bold pt-2 pb-2 text-uppercase">My Vehicles</h3>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            $(function() {
                $('#data_table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{!! url('/customer/get_vehicles') !!}',
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
