    ...
    <div class="col-lg-12 col-12  layout-spacing">
        <form action="">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12 form-group">
                    <label for="">Select Fuel Station</label>
                ...
                <div class="col-lg-12 col-12 form-group">
                    ...
                    <button type="button" class="btn btn-dark float-right btn_reset" style="width: 150px">Clear</button>
                </div>
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                        <h3 class="font-weight-bold pt-2 pb-2 text-uppercase">Scheduled Request</h3>
                    </div>
                </div>
            </div>
                ...
                <table id="data_table" class="table table-striped" style="width:100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Allocated Petrol (Liter)</th>
                            <th>Allocated Diesel (Liter) </th>
    ...
    <script>
        function deleteConfirmation(id) {
            ...
            $.confirm({
                ...
                title: 'Are you Sure!',
                content: 'Do you want to Dispatch the Selected Fuel Request Scheduled?',
                type: 'red',
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ url('/fuelin/schedules/update') }}",
                                data: data,
                                success: function(response) {
                                    location.href = "{{ url('/fuelin/schedules') }}";
                                }
                            });
                        }
                    },
