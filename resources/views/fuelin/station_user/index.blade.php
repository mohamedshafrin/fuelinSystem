...
@section('content')
        ...
        <div class="col-lg-12 col-12  layout-spacing">
            <a href="{{ url('fuelin/station_user/create') }}" class="btn btn-theme float-right text-uppercase">
                <i class="fa fa-plus"></i> Create New Fuel Station User
            </a>
        </div>
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                            <h3 class="font-weight-bold pt-2 pb-2 text-uppercase">Fuel Stations User</h3>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            ...
            function loadData()
            {
                table = $('#data_table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ url('/fuelin/station_user_get') }}",
                        data: function (d) {
