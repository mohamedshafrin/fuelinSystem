																													...
																													<tr>
																														<td align="center" class="alg_center" valign="top">
																															<p style="color:#fff; font-size:12px; font-weight:400; margin:6px 0px 12px;">
																																Here are the login details for app access.
																															</p>
																														</td>
																													</tr>
																												</tbody>
																								...
																								<tbody>
																									<tr>
																										<td style="padding:0px 0px 20px;" align="center" valign="top">
																											<table bgcolor="#fff" align="center" border="0" cellpadding="0" cellspacing="0" class="wrap100"  width="560">
																												<tbody>
																													<tr>
																														<td style="padding:0px 20px" align="left" class="alg_center" valign="top">
																															<p style="color:#3c3f5a; font-size:14px; font-weight:600; margin:12px 0px 0px;">
																																 Credential's
																															</p>
																														</td>
																													</tr>
																								...
																								<tbody>
																									<tr>
																										<td style="padding:4px 0px;" align="center" valign="top">
																											<a href="{{route('login')}}" style="color:#fff; font-size:16px; font-weight:600; margin:0px 0px; background:#5162d8; padding:10px 0px; display:inline-block; text-decoration:none; width:100%; border-radius:4px;">
																												Access Website
																											</a>
																										</td>
																									</tr>
