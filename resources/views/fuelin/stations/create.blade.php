                ...
                <form method="POST" id="submitForm" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 col-12 mt-5 ">
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="station_name" class="form-control"
                                        value="{{ old('station_name') }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="contact_number" maxlength="10" class="form-control"
                                        value="{{ old('contact_number') }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="email" name="email_address" class="form-control"
                                        value="{{ old('email_address') }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    <label for="exampleFormControlInput2">Allocate Petrol <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="petrol_quota" class="form-control"
                                        value="{{ old('petrol_quota') }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    <label for="exampleFormControlInput2">Allocate Diesel <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="diesel_quota" class="form-control"
                                        value="{{ old('diesel_quota') }}" id="exampleFormControlInput2">
        ...
        $(document).ready(function() {
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/fuelin/fuel_station/create') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
            ...
            function clearError()
            {
                ...
                $('.error_petrol_quota').text('');
                $('.error_diesel_quota').text('');
            }
