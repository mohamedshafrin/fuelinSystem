    ...
    <div class="col-lg-12 col-12 layout-spacing">
        <div class="col-lg-6 col-6">
            <div class="form-group mb-4">
                <a href="{{ url('fuelin/customers/vehicles/'.Crypt::encrypt($vehicles->customer_id)) }}"
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                        <h3 class="p-4 font-weight-bold text-uppercase">Update Vehicle </h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="vehicle_number" class="form-control"
                                        value="{{ $vehicles->vehicle_no }}" id="exampleFormControlInput2">
                            ...
                            <div class="col-lg-6 col-12 form-group">
                                ...
                                <select name="vehicle_type" class="form-control disabled-results vehicle_type">
                                    ...
                                    @foreach ($vehicle_type as $item)
                                        <option value="{{ $item->id }}" {{ $vehicles->vehicle_type == $item->id ? 'selected' : ''}}>{{ $item->type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-6 col-12 form-group">
                                ...
                                <select name="fuel_type" class="form-control disabled-results fuel_type">
                                    <option value=""></option>
                                    <option value="1" {{ $vehicles->fuel_type == '1' ? 'selected' : ''}}>Petrol</option>
                                    <option value="2" {{ $vehicles->fuel_type == '2' ? 'selected' : ''}}>Diesel</option>
                                </select>
        ...
        $(document).ready(function() {
            ...
            $('#submitForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/fuelin/customers/vehicles/update') }}",
                    data: formData,
                    dataType: "JSON",
                    contentType: false,
                    cache: false,
                            ...
                            $.confirm({
                                ...
                                buttons: {
                                    confirm: {
                                        ...
                                        btnClass: 'btn-150',
                                        action: function() {
                                            location.href = "{{ url('fuelin/customers/vehicles/'.Crypt::encrypt($vehicles->customer_id)) }}";
                                        }
                                    },
                                }
                            });
