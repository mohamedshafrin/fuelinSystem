																						...
																						<td align="center" valign="top">
																							<table  align="center" border="0" cellpadding="0" cellspacing="0" class="wrap100" width="560">
																								<tbody>
																									<tr>
																										<td align="center" valign="top">
																											<table style="border-radius:4px;" bgcolor="#7382f4" align="center" border="0" cellpadding="0" cellspacing="0" class="wrap100"  width="100%">
																												<tbody>
																													<tr>
																														<td align="center" class="alg_center" valign="top">
																													...
																													<tr>
																														<td align="center" class="alg_center" valign="top">
																															<p style="color:#fff; font-size:12px; font-weight:400; margin:6px 0px 12px;">
																																Your Station Fuel Request Scheduled
																															</p>
																														</td>
																													</tr>
																												</tbody>
																														...
																														<td style="padding:0px 20px" align="left" class="alg_center" valign="top">
																															<table bgcolor="#fff" align="left" border="0" cellpadding="0" cellspacing="0" class="wrap100"  width="100%">
																																<tbody>
																																	...
																																	<tr>
																																		<td style="padding:7px 10px; border-radius:4px;" bgcolor="#edf1f5" align="center" class="alg_center" valign="top">
																																			<p style="color:#3c3f5a; font-size:13px; font-weight:500; margin:0px 0px 0px; text-align: center">
																																				{{ $fuel_request->scheduled_date }}
																																			</p>
																																		</td>
																																	</tr>
																																</tbody>
																																...
																																<tbody>
																																	...
																																	<tr>
																																		<td style="padding:7px 10px; border-radius:4px;" bgcolor="#edf1f5" align="left" class="alg_center" valign="top">
																																			<p style="color:#3c3f5a; font-size:13px; font-weight:500; margin:0px 0px 0px; border-radius:4px; text-align: center">
																																				{{ $fuel_request->alloc_petrol }} L
																																			</p>
																																		</td>
																																	</tr>
																																</tbody>
